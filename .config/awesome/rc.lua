...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "min https://github.com" ) end,
    ...
    awful.key({ modkey1 }, "Print", function () awful.util.spawn("scrot 'awesome-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
        {description = "Screenshot Full", group = "screenshots"}),
    awful.key({ modkey1, "Shift"  }, "Print", function() awful.util.spawn("gnome-screenshot -i") end,
        {description = "Screenshot Options", group = "screenshots"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
	...
	awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn( terminal.." -e zsh" ) end,
              {description = "terminal with zsh shell", group = "super"}),              
	awful.key({ modkey,  modkey1  }, "Return", function () awful.spawn( terminal.." -e bash" ) end,
              {description = "terminal with bash shell", group = "super"}),              
